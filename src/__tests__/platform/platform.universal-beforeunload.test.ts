describe.skip("UniversalPlatformAdapter - BEFOREUNLOAD MAGIC (skipped: requires brittle browser mocks)", () => {
  it("should achieve 100% by triggering beforeunload in the perfect scenario", async () => {
    ...
    try {
      ...
      expect((adapter as any).inner).toBeInstanceOf(require("../../platform/adapters/browser").BrowserPlatformAdapter);
      ...
      expect((adapter2 as any).inner).toBeInstanceOf(require("../../platform/adapters/browser").BrowserPlatformAdapter);
