...
import { memoryWorkflowResource } from "../../workflows/resource";
...
describe("Workflow Dependency Debug", () => {
  it("should register workflow resource correctly", async () => {
    ...
    console.log("memoryWorkflowResource.id:", memoryWorkflowResource.resource.id);
    console.log("memoryWorkflowResource init:", typeof memoryWorkflowResource.resource.init);
